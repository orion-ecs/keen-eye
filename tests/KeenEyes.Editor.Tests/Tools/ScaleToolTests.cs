...
public class ScaleToolTests : IDisposable
{
    private readonly World world;

    public ScaleToolTests()
    {
        world = new World();
    }
    ...
    [Fact]
    public void DisplayName_ReturnsScale()
    {
        var tool = new ScaleTool();

        Assert.Equal("Scale", tool.DisplayName);
    }

    [Fact]
    public void Icon_ReturnsScale()
    {
        var tool = new ScaleTool();

        Assert.Equal("scale", tool.Icon);
    }
    ...
    public void Tooltip_ReturnsExpectedValue()
    {
        ...
        Assert.Equal("Scale selected entities (R)", tool.Tooltip);
    }

    [Fact]
    public void Shortcut_ReturnsR()
    {
        var tool = new ScaleTool();

        Assert.Equal("R", tool.Shortcut);
    }
