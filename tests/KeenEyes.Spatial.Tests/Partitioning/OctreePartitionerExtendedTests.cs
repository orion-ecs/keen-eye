...
/// <summary>
/// Extended tests for OctreePartitioner covering Span queries, deterministic mode, and additional edge cases.
/// </summary>
public class OctreePartitionerExtendedTests : IDisposable
{
    ...
    public OctreePartitionerExtendedTests()
    {
    ...
    public void QueryRadius_Span_WithMultipleEntities_ReturnsAll()
    {
        ...
        partitioner.Update(entity2, new Vector3(20, 20, 20));
        partitioner.Update(entity3, new Vector3(30, 30, 30));
    ...
    public void QueryBounds_Span_WithMultipleEntities_ReturnsAll()
    {
        ...
        partitioner.Update(entity2, new Vector3(10, 10, 10));
    ...
    public void Update_WithBoundsMoving_UpdatesCorrectly()
    {
        ...
        partitioner.Update(entity1, new Vector3(100, 100, 100), bounds);

        Assert.Equal(1, partitioner.EntityCount);
        var results = partitioner.QueryBounds(new Vector3(90, 90, 90), new Vector3(110, 110, 110)).ToList();
    ...
    public void Constructor_WithNodePoolingEnabled_CreatesSuccessfully()
    {
        ...
        using var pooledPartitioner = new OctreePartitioner(config);
    ...
    public void Constructor_WithNodePoolingDisabled_CreatesSuccessfully()
    {
        ...
        using var nonPooledPartitioner = new OctreePartitioner(config);
    ...
    public void Update_WithDeeplyNestedSubdivisions_HandlesCorrectly()
    {
        ...
        for (int i = 0; i < 100; i++)
        {
            ...
            var position = new Vector3(scale, scale, scale);
