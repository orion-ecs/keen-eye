...
This sample uses `LocalTransport` for in-process testing. For production, implement `INetworkTransport` with a real networking library like LiteNetLib or ENet.
