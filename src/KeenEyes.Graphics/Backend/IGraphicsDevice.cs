...
/// <summary>
/// Abstraction layer for graphics device operations.
/// </summary>
/// <remarks>
/// <para>
/// This interface abstracts low-level GPU operations to enable:
/// <list type="bullet">
///   <item>Unit testing with mock implementations</item>
///   <item>Swapping graphics backends (OpenGL, Vulkan, etc.)</item>
///   <item>Clean separation between rendering logic and GPU API</item>
/// </list>
/// </para>
/// </remarks>
public interface IGraphicsDevice : IDisposable
{
    ...
    /// <param name="data">The pixel data (RGBA).</param>
    void TexImage2D(TextureTarget target, int level, int width, int height, ReadOnlySpan<byte> data);
