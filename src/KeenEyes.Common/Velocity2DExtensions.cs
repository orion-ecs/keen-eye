...
/// <summary>
/// Extension properties for <see cref="Velocity2D"/> component.
/// </summary>
/// <remarks>
...
public static class Velocity2DExtensions
{
    ...
    public static float Magnitude(this in Velocity2D velocity)
    {
    ...
    /// </remarks>
    public static float MagnitudeSquared(this in Velocity2D velocity)
    {
